      ...
      <Show when={isBotDisplayed()}>
        <div
          style={{
            ...
            height: props.theme?.chatWindow?.height ? `${props.theme?.chatWindow?.height.toString()}px` : '80vh',
            width: props.theme?.chatWindow?.width ? `${props.theme?.chatWindow?.width.toString()}px` : '130%',
            margin: '0px',
          }}
        >
          <Bot
